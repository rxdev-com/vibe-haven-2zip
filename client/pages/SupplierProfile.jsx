...
export default function SupplierProfile() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AppHeader title="Profile" badgeColor="bg-emerald-100 text-emerald-700" />
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <Card className="mb-6 overflow-hidden">
            <div className="h-24 bg-gradient-to-r from-emerald-500 to-green-500" />
            ...
            <CardContent className="space-y-4">
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g. Kumar Oil Mills"
                  />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Tell vendors about your business and the products you supply"
                />
              </div>
              <Button
                onClick={handleSave}
